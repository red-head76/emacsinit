...
;; ergoemacs compatible
(global-set-key (kbd "M-h") 'prelude-move-beginning-of-line)
...
(global-set-key (kbd "M-#") 'prelude-smart-open-line)
(global-set-key (kbd "M-~") 'prelude-smart-open-line-above)
